...
* [How to avoid downtime when deploying new code](https://intranet.hbtn.io/rltoken/wYpewVpIp9PSqqL27RPafg)
* [High availability cluster (active-active/active-passive)](https://intranet.hbtn.io/rltoken/Mlvynt0OgLQXrxjrC5Wlnw)
